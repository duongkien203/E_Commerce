...
function VerifyOTP() {
  ...
  const handleVerifyOTP = (otp) => {
    ...
    fetch("http://localhost/E_Commerce/backend/admin/api/VerifyOTP.php", {
      method: "POST",
      ...
      .then((data) => {
        if (data.status === "success") {
          ...
          setTimeout(() => navigate(`/admin/change-password/${otp}`), 2000); // Chuyển hướng sau 2s
        } else {
  ...
  return (
    <div
      ...
      style={{ width: "350px", margin: "auto", marginTop: "20px" }}
    >
